...
export default function RelatedProducts({ products }: RelatedProductsProps) {
  ...
  return (
    <div className="flex justify-center flex-wrap flex-col items-center featured-collection w-full py-6 sm:py-10 sm:px-0">
      <h2 className="sm:text-3xl text-2xl  text-center mb-6 sm:mb-12">Related Products</h2>

      <div className="w-full container max-w-6xl grid gap-4 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
  ...
  ₹{product.variants.nodes[0]?.compareAtPrice?.amount ? 
    Math.round(parseFloat(product.variants.nodes[0].compareAtPrice.amount)).toLocaleString('en-IN') : 
    ''}
</span>
